...
#Define directories
dir_data_original = '/storage/awias/s174197/data_Verse/Verse20_'+data_type+'_unpacked'
dir_data_stage1 = '/storage/awias/s174197/data_Verse/SpineLocalisation/Verse20_'+data_type+'_prep_NOPADDING' #'/zhome/bb/f/127616/Documents/Thesis/Rawdata_training'
dir_data_stage2 = '/storage/awias/s174197/data_Verse/VertebraeLocalisation2/Verse20_'+data_type+'_prep_NOPADDING' #'/zhome/bb/f/127616/Documents/Thesis/Rawdata_training'
dir_data_stage3 = '/storage/awias/s174197/data_Verse/VertebraeSegmentation/Verse20_'+data_type+'_prep_NOPADDING' #'/zhome/bb/f/127616/Documents/Thesis/Rawdata_training'
checkpoint_dir_stage1 = '/storage/awias/s174197/Checkpoints/SpineLocalisation/First_try2950_batchsize1_lr0.0001_wd0.0005.pth' #r'E:\Andreas_s174197\Thesis\My_code\My_networks\Spine_Localisation\Checkpoints\checkpoint_batchsize1_lr0.0001_wd0.0005.pth'
if do_batchnorm == 1:
    checkpoint_dir_stage2 = '/storage/awias/s174197/Checkpoints/VertebraeLocalisation2/Only_elastic_earlystopping_epoch1040_batchsize1_lr1e-05_wd0.0001.pth'
else:
    checkpoint_dir_stage2 = '/storage/awias/s174197/Checkpoints/VertebraeLocalisation2/First_try/First_try_epoch430_batchsize1_lr1e-05_wd0.0001.pth'
checkpoint_dir_stage3 = '/storage/awias/s174197/Checkpoints/VertebraeSegmentation/FIXED_DATAAUG_rotation_step13250_batchsize1_lr1e-05_wd0.0005.pth' #FIXED_DATAAUG_rotation_step13300_batchsize1_lr1e-05_wd0.0005.pth' #only_elastic2_again_step33650_batchsize1_lr1e-05_wd0.0005.pth' #FIXED_DATAAUG_rotation_step11950_batchsize1_lr1e-05_wd0.0005.pth' #only_elastic2_again_step33650_batchsize1_lr1e-05_wd0.0005.pth' #'/storage/awias/s174197/data/Checkpoints/VertebraeSegmentation/Only_rotation_batchsize1_lr1e-05_wd0.0005.pth'
predictions_folder = '/storage/awias/s174197/data_Verse/Predictions_GPU9'
...
for subject in tqdm(all_subjects):  
    ...
    checkpoint = torch.load(checkpoint_dir_stage1,map_location=device, weights_only=False)
    ...
    #Predictions stage 2
    #Load checkpoint
    checkpoint = torch.load(checkpoint_dir_stage2,map_location=device, weights_only=False)
    ...
    #Load model
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu') #device = torch.device('cpu')
    checkpoint = torch.load(checkpoint_dir_stage3,map_location=device, weights_only=False)
