...
for subject in tqdm(all_subjects):
    ...
    # x_range = [max(new_x_COM-48,0),min(new_x_COM+47,dim1)]
    # y_range = [max(new_y_COM-48,0),min(new_y_COM+47,dim2)]
    # z_range = [0,0]
    ...
    z_convert = [z_min_restrict - z_range[0]-lowest_z_voxel_cropped,z_min_restrict - z_range[0]-lowest_z_voxel_cropped+ dim3] #z_range[0] will be zero, if you use COM for cropping instead of bounding box
