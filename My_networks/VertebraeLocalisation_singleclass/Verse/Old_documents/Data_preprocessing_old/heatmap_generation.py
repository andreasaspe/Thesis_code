...
#gpu cluster
dir_data = '/scratch/s174197/data/Verse20/VertebraeLocalisation/Verse20_test_prep' #"/Users/andreasaspe/Documents/Data/Verse20/Verse20_training_prep" #"/Users/andreasaspe/Documents/Data/Verse20_training_prep" #r'C:\Users\PC\Documents\Andreas_s174197\Preprocessed_data' #PARENT FOLDER #'/zhome/bb/f/127616/Documents/Thesis/Preprocessed_data/'
Output_folder = '/scratch/s174197/data/Verse20/VertebraeLocalisation/Verse20_test_heatmaps' #"/Users/andreasaspe/Documents/Data/Verse20_training_heatmaps" #r'C:\Users\PC\Documents\Andreas_s174197\heatmaps' #"/zhome/bb/f/127616/Documents/Thesis/Heatmaps/"
...
for filename in os.listdir(img_dir):
    ...
    for ctd in ctd_list[1:]:
        if 17 <= ctd[0] <= 24:
            new_heatmap = gaussian_kernel_3d(origins = (ctd[1],ctd[2],ctd[3]), meshgrid_dim = (dim1,dim2,dim3), sigma = 5)
