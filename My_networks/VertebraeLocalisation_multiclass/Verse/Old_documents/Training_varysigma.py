...
checkpoint_dir = '/home/s174197/Thesis/MY_CODE/My_networks/VertebraeLocalisation/Checkpoints' #'/Users/andreasaspe/Library/Mobile Documents/com~apple~CloudDocs/DTU/12.semester/Thesis/My_code/My_networks/Spine_Localisation/Checkpoints'
checkpoint_filename = 'second_try'
...
# ctd_dir_training = '/Users/andreasaspe/Documents/Data/Verse20/VertebraeLocalisation/Verse20_training_prep/ctd'
...
# ctd_dir_validation = '/Users/andreasaspe/Documents/Data/Verse20/VertebraeLocalisation/Verse20_validation_prep/ctd'


#Define sigma and alpha
alpha = 100
#sigma = torch.tensor([0.0], requires_grad=True)
...
VerSe_val = LoadData(img_dir=img_dir_validation, ctd_dir=ctd_dir_validation)
...
def generate_targets(ctd_list,image,sigma):
    ...
    for ctd in ctd_list[1:]:
        if 17 <= ctd[0] <= 24:
            ...
            heatmap = gaussian_kernel_3d(origins = (ctd_items[1],ctd_items[2],ctd_items[3]), meshgrid_dim = (dim1,dim2,dim3), sigma = sigma[ctd_index])
...
params_optimize = list(model.parameters())+[loss_fn.sigma] #List of parameters to optimize. In this case model parameters and sigma. I do it like this, to get a flat list instead of a nested list.
optimizer = optim.SGD(params=params_optimize, lr = lr, weight_decay=wd, momentum=0.9, nesterov=True)
#optimizer = optim.Adam(params=params_optimize, lr = lr, weight_decay=wd) #Oprindeligt stod der 0.0001
