...
class Unet3D(nn.Module):
    def __init__(self, dropout):
        ...
        #Dropout layers
        # self.dropout01 = nn.Dropout3d(p=0.1)
        # self.dropout02 = nn.Dropout3d(p=0.2)
        # self.dropout03 = nn.Dropout3d(p=0.3)
        # self.dropout04 = nn.Dropout3d(p=0.4)
        # self.dropout05 = nn.Dropout3d(p=0.5)
